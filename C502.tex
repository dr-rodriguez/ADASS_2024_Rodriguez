...
\author{David~R.~Rodriguez,$^1$ M.~Arevalo,$^2$ P.~Dowler,$^3$ J.~Espinosa,$^2$ B.~McLean,$^1$ and P.~Dowler$^3$}
\affil{$^1$Space Telescope Science Institute, Baltimore, MD, USA; \email{AuthorEmail@email.edu}}
